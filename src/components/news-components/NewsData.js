...
import { Breadcrumb, Button, Divider, ConfigProvider, Input, Row } from "antd";
    ...
    <ConfigProvider theme={{ token: { colorSplit: "#00b96b" } }}>
      ...
      <div className="news-content">
        <Breadcrumb
          items={[
            {
              title: <Button onClick={inputTypeHandlerAll}>All</Button>,
            },

            {
              title: <Button onClick={inputTypeHandlerOne}>Events</Button>,
            },
            {
              title: <Button onClick={inputTypeHandlerTwo}>Articles</Button>,
            },
          ]}
        />
        <Divider />{" "}
